...
def image_to_ascii(image_path, output_width=100, char_ratio=0.5):
    ...
    # Resize the image whith original aspect ratio
    ...
    ascii_art = "\n".join([ascii_art[i:i+output_width] for i in range(0, len(ascii_art), output_width)])

    print(ascii_art)

if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python3 program.py <image_path>")
    else:
